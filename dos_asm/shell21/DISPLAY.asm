...
No_draw:
     ...
     mov dx,Num_dx ;Получим начальное значение рамки (верхний левый угол - ╔)
...
Check_video proc
     mov ah,0Fh ; функция проверки режима монитора
     int 10h 
...
Ok_video:
     ...
     mov ax,0500h ; установка страницы 0, функция 5
     int 10h
